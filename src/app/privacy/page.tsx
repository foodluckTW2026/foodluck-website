...
const merchantAppRows = [
    ...
    [
        "信用卡資訊",
        "用於月結手續費扣款之信用卡資料，由 PAYUNi 金流服務商直接處理及保管，本公司不儲存、不接觸卡號",
        "使用者主動提供，PAYUNi 直接處理",
    ],
    ...
    [
        "合約簽署資料",
        "合約版本、簽署狀態、簽署時間、店家電子簽名圖檔或簽名紀錄",
        "店家於 APP 內簽署合約時主動提供或系統產生",
    ],
    [
        "裝置硬體存取",
        "相機拍攝之照片、相簿中選取之圖片",
...
const purposes = [
    ...
    "完成店家服務合約、條款更新或其他法律文件之線上簽署、履約管理及爭議處理。",
    "處理店家版月結手續費扣款及相關金流事宜。",
...
const retentionRows = [
    ...
    [
        "店家合約簽署資料",
        "自合約終止或最後交易完成日起至少 5 年",
        "依相關法令、會計稅務及爭議處理所需期限保存",
    ],
...
const dataSharingItems = [
    ...
    "為提供核心服務所必要之第三方服務商（如 PAYUNi 處理店家版月結手續費扣款），均受保密義務約束。",
...
const securityItems = [
    ...
    "店家版月結手續費之信用卡扣款資料由 PCI DSS 合規之 PAYUNi 處理，本公司不接觸卡號；消費者於本服務採現場付款方式，本公司不蒐集任何消費者付款資料。",
    "店家結款帳戶資訊存放於受存取控制之系統，僅授權之財務人員可存取。",
    "店家電子簽名及合約簽署紀錄存放於受存取控制之系統，僅授權人員得於合約管理、客服、法務或爭議處理必要範圍內存取。",
                    ...
                    <div className="grid gap-10 lg:grid-cols-[240px_minmax(0,1fr)]">
                        ...
                        <div className="min-w-0 space-y-10">
                            ...
                            <Section id="contact" title="第十六條 聯絡我們">
                                <p className="text-base leading-8 text-gray-700">
                                    如對本隱私權政策有任何疑問，或需要行使個資相關權利，請透過下列方式聯繫本公司：
                                </p>
