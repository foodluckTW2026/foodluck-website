                            ...
                            >
                                <div className="space-y-6">
                                    ...
                                    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                                        ...
                                        <p className="mt-3 text-base leading-8 text-gray-700">
                                            若消費者於取餐後發現食品有腐敗、發霉、異味等明顯變質情形，請第一時間保留食品現狀（如尚未丟棄）及相關照片，並透過
                                            APP
                                            申訴功能或客服管道聯繫本平台。本平台將於收到通知後立即啟動審核程序，審核期間將先行提供全額退費，以保障消費者權益。
                                        </p>
                                        <p className="mt-3 text-base leading-8 text-gray-700">
                                    ...
                                    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                                        ...
                                        <p className="mt-3 text-base leading-8 text-gray-700">
                                            ...
                                            Luckie
                                            Bag，本平台將主動取消該筆預約並通知消費者，並核發折價券作為補償。因本服務採現場付款方式，消費者尚未付款，無需另行申訴。
                                        </p>
                                    </div>
